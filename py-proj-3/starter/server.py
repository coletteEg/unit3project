...
import jinja2
import melons from forms import LoginForm

app = Flask(__name__)
app.jinja_env.undefined = jinja2.StrictUndefined
app.secret_key = "isitboilinglavahot"
...
def add_to_cart(melon_id):
   ...
   flash(f"The {melon_id} melon is waiting in your cart!")
   print(cart)
...
def logout():
   ...
   flash("Bye bye! Come back soon <3")
   return redirect("/login")
